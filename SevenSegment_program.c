...
{
	DIO_voidSetPinValue(Copy_u8CathodePort,2,DIO_u8LOW);
	DIO_voidSetPinValue(Copy_u8CathodePort,3,DIO_u8LOW);
	...
	case 8 :DIO_voidSetPortValue(Copy_u8AnodePort,0b00001000);break;
	case 9 :DIO_voidSetPortValue(Copy_u8AnodePort,0b00001001);break;
	}
}
